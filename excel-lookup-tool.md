#Copilot prompt to generate lookup tool in new worksheets without manually writing formulas. Open the xl data file before using this prompt.Ensure the xl file has same header names
