...
Below it, display the following fields automatically retrieved from the authentication dataset: User_ID Application_Name Region Login_Date Auth_Method MFA_Enabled Login_Status Response_Time_ms Failure_Reason
Use best-practice Excel formulas. Add error handling so that if the Login_ID is not found, it displays "Login Not Found".
